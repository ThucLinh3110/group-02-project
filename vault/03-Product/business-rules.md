...
| **BR-HD-04** | Quy định thời gian xử lý (SLA): Urgent = 4 giờ; High = 24 giờ (1 ngày); Medium = 3 ngày; Low = 7 ngày. Mốc "At Risk" (Cảnh báo đỏ) kích hoạt trước khi hết hạn 20% thời gian. |
...
| **ASM-HD-03** | Giả định Demo: Để thuận tiện cho việc trình diễn luồng chuyển trạng thái SLA trên UI Dashboard sát giờ báo cáo, nhóm thống nhất cấu hình tạm thời (hard-code) mọi vé đều đếm ngược chung mốc 24 giờ. |
