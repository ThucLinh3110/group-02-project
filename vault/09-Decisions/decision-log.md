...
| ID | Ngày | Vấn đề / Bối cảnh | Quyết định được chốt | Người chốt |
|---|---|---|---|---|
| DEC-01 | 24/08/2026 | Chọn đề tài môn học | Lựa chọn đề tài "Hệ thống Quản lý Lỗi IT tích hợp AI" (AI Helpdesk) để giải quyết bài toán chậm trễ SLA. | Cả nhóm |
